 ...
 *      - An expired SSO token in `~/.aws/sso/cache` is silently refreshed via
 *        SSO-OIDC CreateToken (cached refresh token + client registration) and
 *        written back to the cache, matching the AWS SDK/CLI — no
